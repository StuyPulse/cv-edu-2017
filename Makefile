...
OPENCV_JAR = $(OPENCV)/build/bin/opencv-320.jar2$(PROJECT_ROOT)/java/opencv-320.jar:/usr/local/Cellar/opencv3/3.2.0/share/OpenCV/java/opencv-320.jar:/usr/local/Cellar/opencv3/3.0.0/share/OpenCV/java/opencv-300.jar
